...
@section('content')
    <div class="col-md-12">
        ...
        <form class="well form-horizontal" action="{{route('paginas.atualiza',$pagina->id)}}" method="post"
              enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group" id="vtitulo">
                <label class="col-md-1 control-label" for="Titulo:">Titulo:</label>
                <div class="col-md-11">
                    <input id="titulo" name="titulo" value="{{$pagina->nome_pagina}}" min="5" type="text" placeholder="Informe o Titulo"
            ...
            <div class="form-group" id="vmateria">
                ...
                <div class="col-md-11">
                     <textarea name="materia" id="editor" cols="10" class="form-control"
                               rows="3">{{$pagina->conteudo_pagina}}</textarea>
                </div>
            </div>
                        ...
                        <div class="col-md-10">
                            <select name="categoria" id="categoria" class="form-control">
                                ...
                                @foreach($menus as $menu)
                                    @if($menu->id == $pagina->menu_id)
                                        <option value="{{$menu->id}}" selected>{{$menu->nome_menu}}</option>
                                    @else
            ...
            <button class="btn btn-block btn-danger">Atualizar</button>
