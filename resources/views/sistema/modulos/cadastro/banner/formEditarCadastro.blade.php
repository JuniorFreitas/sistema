...
@section('content')
    <div class="col-md-12">
        ...
        <div class="well">
            <form class="form-horizontal" method="post" action="{{route('banner.atualiza',$banner->id)}}"
                ...
                <div class="form-group" id="vtitulo">
                    ...
                    <div class="col-md-11">
                        <input id="titulo" name="titulo" value="{{$banner->titulo_banner}}" min="" type="text" placeholder="Informe um titulo"
                ...
                <div class="form-group" id="vurl">
                    ...
                    <div class="col-md-11">
                        <input id="url" name="url" value="{{$banner->url_banner}}" min="" type="text" placeholder="Informe uma url"
                               class="form-control input-md">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-8">
                            <b>Banner cadastrado:</b>
                            <img src="{{asset('uploads')."/".$banner->img_banner}}" class="img-responsive" alt="banner">
                        </div>
