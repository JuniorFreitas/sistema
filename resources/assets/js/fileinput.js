...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        msgFileNotReadable: 'O arquivo "{name}" nÃ£o Ã© legÃ­vel.',
        msgFilePreviewAborted: 'PrÃ©-visualizaÃ§Ã£o do arquivo abortada para "{name}".',
        msgFilePreviewError: 'Ocorreu um erro ao ler o arquivo "{name}".',
        msgInvalidFileType: 'Tipo invÃ¡lido para o arquivo "{name}". apenas "{types}" arquivos sÃ£o suportados.',
        msgInvalidFileExtension: 'ExtensÃ£o invÃ¡lido para do arquivo "{name}". apenas "{extensions}" arquivos sÃ£o suportados.',
